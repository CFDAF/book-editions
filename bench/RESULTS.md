...
| 4 | **No "first edition differs" inference**: the header shows the original and, always, "earliest edition found" (year, language, publisher), a statement about the catalogues. Editions dated before the original's known year are left out of it | none on Stage 2. Revises decision 2. The rule is **untested** on the Stage 1 listings |
